...
const normalizedWords = function (/* */) {
...
const uniqueWords = function (/* */) {
  /* your response here */const getUniqueWords = function getUniqueWords(text) {
...
const wordCount = function (/* */) {
  /* your response here */const wordCount = function wordCount(text, unique) {
