...
const normalizeWords = function getNormalizedWords(stringInput) {
...
const uniqueWords = function normalizeWords(stringInput) {
  let uniqueWords = {};
...
const wordFrequencies = function (stringInput) {
